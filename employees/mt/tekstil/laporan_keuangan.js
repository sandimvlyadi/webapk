function generateTable()
{
	...
	$.get(baseurl + 'ajax_service/load?request=81396fc8a8beb3d2370e94d6b43c3bcd&id_user='+ tokenData.id_user +'&token='+ tokenData.token, function(response){
		if (response.result) {
...
$('#filter').on('click', '.btn-success', function(){
	...
	$.post(baseurl + 'ajax_service?request=2b4a8978690586de38b02cfdbd66e92c', 
	{
