function generateTable()
{
	...
	$.get(baseurl + 'ajax_service/load?request=fb7bb7f807d4116ca6d99f2b2dfdb62a&id_user='+ tokenData.id_user +'&token='+ tokenData.token, function(response){
		if (response.result) {
...
$('#filter').on('click', '.btn-success', function(){
	...
	$.post(baseurl + 'ajax_service?request=d4eadc6475a64babdeb6d0a252344b80', 
	{
