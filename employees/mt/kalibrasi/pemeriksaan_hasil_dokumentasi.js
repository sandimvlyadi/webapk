function generateTable()
{
	...
	$.get(baseurl + 'ajax_service/load?request=78b928d3ececaf1694d0bad0dbfbc0f3&id_user='+ tokenData.id_user +'&token='+ tokenData.token, function(response){
		if (response.result) {
...
$('.box:eq(1) .box-footer').on('click', '.btn-success', function(){
	...
	$.post(baseurl + 'ajax_service?request=538931e29885a51f969d3ed4b3b4131c', 
	{
		'id'	: id,
		'token'	: tokenData
	},
...
$('.box:eq(1) .box-footer').on('click', '.btn-danger', function(){
	...
	$.post(baseurl + 'ajax_service?request=8226e653e730d7b3f4b458fa0dea0084', 
	{
		'id'	: id,
		'token'	: tokenData
	},
...
$('#tablePemeriksaanHasilDokumentasi').on('click', '.btn-success', function(){
	...
	$.post(baseurl + 'ajax_service?request=2f1b013317af514d58cc387ce0569f3e', 
	{
		'id'	: id,
		'token'	: tokenData
	},
...
$('#tablePemeriksaanHasilDokumentasi').on('click', '.btn-danger', function(){
	...
	$.post(baseurl + 'ajax_service?request=73c9bfc816eddbc373b533076cacfe2e', 
	{
		'id'	: id,
		'token'	: tokenData
	},
