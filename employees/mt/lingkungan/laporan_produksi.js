function generateTable()
{
	...
	$.get(baseurl + 'ajax_service/load?request=ddbdebdc3c1fe7a2c7e7612b2f890dec&id_user='+ tokenData.id_user +'&token='+ tokenData.token, function(response){
		if (response.result) {
...
$('#filter').on('click', '.btn-success', function(){
	...
	$.post(baseurl + 'ajax_service?request=4504a72a037c1674f5a38f2cd280e992', 
	{
