function generateTable()
{
	...
	$.get(baseurl + 'ajax_service/load?request=7ba2c01cc5fe13fe7a31c6d1859e31c4&id_user='+ tokenData.id_user +'&token='+ tokenData.token, function(response){
		if (response.result) {
...
$('#tableInfoKesanggupan').on('click', '.btn-success', function(){
	...
	$.post(baseurl + 'ajax_service?request=652b3fb6de9ca94ae8709c6aa04f502f', 
	{
		'id'	: id,
		'token'	: tokenData
	},
...
$('#tableInfoKesanggupan').on('click', '.btn-danger', function(){
	...
	$.post(baseurl + 'ajax_service?request=fe86aaf3b27fd09d71f78a57e44e48e5', 
	{
		'id'	: id,
		'token'	: tokenData
	},
