function generateTable()
{
	...
	$.get(baseurl + 'ajax_service/load?request=145ba3251860a532d6829b6d415aa714&id_user='+ tokenData.id_user +'&token='+ tokenData.token, function(response){
		if (response.result) {
...
$('.box:eq(1) .box-footer').on('click', '.btn-success', function(){
	...
	$.post(baseurl + 'ajax_service?request=6a7e6c869f902eefa80443572997ddd4', 
	{
		'id'	: id,
		'token'	: tokenData
	},
...
$('.box:eq(1) .box-footer').on('click', '.btn-danger', function(){
	...
	$.post(baseurl + 'ajax_service?request=562bef396496ccc0ea14a71e83c4dfe5', 
	{
		'id'	: id,
		'token'	: tokenData
	},
...
$('#tablePemeriksaanHasilDokumentasi').on('click', '.btn-success', function(){
	...
	$.post(baseurl + 'ajax_service?request=d5a68ad8cfb578ecaa8190a5b8a027e7', 
	{
		'id'	: id,
		'token'	: tokenData
	},
...
$('#tablePemeriksaanHasilDokumentasi').on('click', '.btn-danger', function(){
	...
	$.post(baseurl + 'ajax_service?request=0f8b894c93038d9b7ed36fb58f1e3db8', 
	{
		'id'	: id,
		'token'	: tokenData
	},
