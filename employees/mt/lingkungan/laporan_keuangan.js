function generateTable()
{
	...
	$.get(baseurl + 'ajax_service/load?request=21b525bd987baa625ddf29b979aeb196&id_user='+ tokenData.id_user +'&token='+ tokenData.token, function(response){
		if (response.result) {
...
$('#filter').on('click', '.btn-success', function(){
	...
	$.post(baseurl + 'ajax_service?request=b488da05c0a93a0cfde91679c1566ec8', 
	{
