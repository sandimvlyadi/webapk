function generateTable()
{
	...
	$.get(baseurl + 'ajax_service/load?request=699e5630fb59b63ce2ccab730e4b4fbd&id_user='+ tokenData.id_user +'&token='+ tokenData.token, function(response){
		if (response.result) {
...
$('#tablePekerjaanAnalis').on('click', '.btn-success', function(){
	...
	$.post(baseurl + 'ajax_service?request=d6afc70ce770d2867389b147013d34a0', 
	{
		'id'	: id,
		'token'	: tokenData
	},
...
$('#tablePekerjaanAnalis').on('click', '.btn-danger', function(){
	...
	$.post(baseurl + 'ajax_service?request=b9ca4513cc99a1fcdd2d3a9e9a5e719f', 
	{
		'id'	: id,
		'token'	: tokenData
	},
...
$('#tableProsesPengujian').on('click', '.btn-danger', function(){
	...
	$.post(baseurl + 'ajax_service?request=54d69a364b5b0a6ae6e84c1c383cc87b', 
	{
		'data'		: data,
		'token'		: tokenData
	},
...
$('.box:eq(1) .box-footer').on('click', '.btn-success', function(){
	...
	$.post(baseurl + 'ajax_service?request=5c2ff7f6331a70bbfd00bf43884d3e1b', 
	{
		'id'		: id,
		'token'		: tokenData
	},
