function generateTable()
{
	...
	$.get(baseurl + 'ajax_service/load?request=ec6cf320eea2b18f0a22051879cb98c2&id_user='+ tokenData.id_user +'&token='+ tokenData.token, function(response){
		if (response.result) {
...
$('#tablePekerjaanAnalis').on('click', '.btn-success', function(){
	...
	$.post(baseurl + 'ajax_service?request=fb8ad96d98161c1f27a7a555b4c06f6f', 
	{
		'id'	: id,
		'token'	: tokenData
	},
...
$('#tablePekerjaanAnalis').on('click', '.btn-danger', function(){
	...
	$.post(baseurl + 'ajax_service?request=0b16ea3fbc98d913e074dfce2f05762c', 
	{
		'id'	: id,
		'token'	: tokenData
	},
...
$('#tableProsesPengujian').on('click', '.btn-danger', function(){
	...
	$.post(baseurl + 'ajax_service?request=ae3c663ae95df6c7dc8a629f0e7a1b4b', 
	{
		'data'		: data,
		'token'		: tokenData
	},
...
$('.box:eq(1) .box-footer').on('click', '.btn-success', function(){
	...
	$.post(baseurl + 'ajax_service?request=7069be195ccbf5931f00854b5913e803', 
	{
		'id'		: id,
		'token'		: tokenData
	},
