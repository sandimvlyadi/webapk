function generateTable()
{
	...
	$.get(baseurl + 'ajax_service/load?request=63232e75fa4702f31c846908ca50e891&id_user='+ tokenData.id_user +'&token='+ tokenData.token, function(response){
		if (response.result) {
...
$('#tablePekerjaanAnalis').on('click', '.btn-success', function(){
	...
	$.post(baseurl + 'ajax_service?request=e54a6ef4b8eee622c2a2da8f13e0728b', 
	{
		'id'	: id,
		'token'	: tokenData
	},
...
$('#tablePekerjaanAnalis').on('click', '.btn-danger', function(){
	...
	$.post(baseurl + 'ajax_service?request=13257c20284994baa1c482ca4d9809e6', 
	{
		'id'	: id,
		'token'	: tokenData
	},
...
$('#tableProsesPengujian').on('click', '.btn-danger', function(){
	...
	$.post(baseurl + 'ajax_service?request=296bc5c121ed4a7fe8b92c9c92ce5e24', 
	{
		'data'		: data,
		'token'		: tokenData
	},
...
$('.box:eq(1) .box-footer').on('click', '.btn-success', function(){
	...
	$.post(baseurl + 'ajax_service?request=e61f11617a7d66c89562e8562067f7e0', 
	{
		'id'		: id,
		'token'		: tokenData
	},
