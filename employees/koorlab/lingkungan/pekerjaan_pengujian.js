function generateTable()
{
	...
	$.get(baseurl + 'ajax_service/load?request=46ca9cfd6863bd6bde1714f5b60a8fde&id_user='+ tokenData.id_user +'&token='+ tokenData.token, function(response){
		if (response.result) {
...
$('#tablePekerjaanPengujian').on('click', '.btn-success', function(){
	...
	$.post(baseurl + 'ajax_service?request=76c26271322ec4a3a2402cd2f8f158a7', 
	{
		'id'	: id,
		'token'	: tokenData
	},
...
$('.box:eq(1) .box-footer').on('click', '.btn-success', function(){
	...
	$.post(baseurl + 'ajax_service?request=eecdc500d1d96e807820eb6be5c50d5f', 
	{
		'id'		: id,
		'analis'	: analis,
		'token'		: tokenData
