function generateTable()
{
	...
	$.get(baseurl + 'ajax_service/load?request=70c9db6b217048b91793f0ebe4aff367&id_user='+ tokenData.id_user +'&token='+ tokenData.token, function(response){
		if (response.result) {
...
$('#tablePekerjaanPengujian').on('click', '.btn-success', function(){
	...
	$.post(baseurl + 'ajax_service?request=cac530299f963869422b6542a3dd0c69', 
	{
		'id'	: id,
		'token'	: tokenData
	},
...
$('.box:eq(1) .box-footer').on('click', '.btn-success', function(){
	...
	$.post(baseurl + 'ajax_service?request=72e2d12fea3a0856471a5da4a5a1fe5a', 
	{
		'id'		: id,
		'analis'	: analis,
		'token'		: tokenData
