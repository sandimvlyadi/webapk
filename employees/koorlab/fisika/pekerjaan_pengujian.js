function generateTable()
{
	...
	$.get(baseurl + 'ajax_service/load?request=c8f3f110f4c8619619511c0cc32a9b71&id_user='+ tokenData.id_user +'&token='+ tokenData.token, function(response){
		if (response.result) {
...
$('#tablePekerjaanPengujian').on('click', '.btn-success', function(){
	...
	$.post(baseurl + 'ajax_service?request=f10b6ea58ff1495f827253838a97a89a', 
	{
		'id'	: id,
		'token'	: tokenData
	},
...
$('.box:eq(1) .box-footer').on('click', '.btn-success', function(){
	...
	$.post(baseurl + 'ajax_service?request=fe306d68510f47a85d2998f7d74f7a9a', 
	{
		'id'		: id,
		'analis'	: analis,
		'token'		: tokenData
