...
function generateTable()
{
	...
	$.get(baseurl + 'ajax_service/load?request=579be05eb7e0499f34f11835a9cefaca&id_user='+ tokenData.id_user +'&token='+ tokenData.token, function(response){
		if (response.result) {
...
$('#tablePemeriksaanHasilPengujian').on('click', '.btn-success', function(){
	...
	$.post(baseurl + 'ajax_service?request=a35e10084967a35ef80fffee6da10719', 
	{
		'id'	: id,
		'token'	: tokenData
	},
...
$('#tablePemeriksaanHasilPengujian').on('click', '.btn-danger', function(){
	...
	$.post(baseurl + 'ajax_service?request=aba2e23345d6e4a01423bec4539254c2', 
	{
		'id'	: id,
		'token'	: tokenData
	},
...
$('#tableDataHasilPengujian').on('click', 'input[type=checkbox]', function(){
	var id = $(this).val();
  	...
  	$.post(baseurl + 'ajax_service?request=b5af72a7ad80088570522117d2137680',
  	{
    	'data' 	: data,
    	'token'	: tokenData
  	},
...
$('.box:eq(1) .box-footer').on('click', '.btn-danger', function(){
	...
	$.post(baseurl + 'ajax_service?request=4d64df456751dfd066da375e49174627', 
	{
		'id'		: id,
		'token'		: tokenData
	},
...
$('.box:eq(1) .box-footer').on('click', '.btn-success', function(){
	...
	$.post(baseurl + 'ajax_service?request=d52db1d87c4ff2092d9751c6f93b6df9', 
	{
		'id'		: id,
		'token'		: tokenData
	},
